...
files = [
    ...
    (("vendor", "SFML-3.0.0", "bin", "sfml-audio-2.dll"), (""), ""),
    (("vendor", "SFML-3.0.0", "bin", "sfml-system-2.dll"), (""), ""),
    (("vendor", "SFML-3.0.0", "bin", "sfml-graphics-2.dll"), (""), ""),
    (("vendor", "SFML-3.0.0", "bin", "sfml-network-2.dll"), (""), ""),
    (("vendor", "SFML-3.0.0", "bin", "sfml-window-2.dll"), (""), ""), 
    (("vendor", "SFML-3.0.0", "bin", "sfml-audio-d-2.dll"), ("bin", "debug"), ""),
    (("vendor", "SFML-3.0.0", "bin", "sfml-system-d-2.dll"), ("bin", "debug"), ""),
    (("vendor", "SFML-3.0.0", "bin", "sfml-graphics-d-2.dll"), ("bin", "debug"), ""),
    (("vendor", "SFML-3.0.0", "bin", "sfml-network-d-2.dll"), ("bin", "debug"), ""),
    (("vendor", "SFML-3.0.0", "bin", "sfml-window-d-2.dll"), ("bin", "debug"), ""),
